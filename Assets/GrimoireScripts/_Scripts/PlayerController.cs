...
namespace GrimoireScripts
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        public bool WallSliding => _isOnWall;
        ...
        protected virtual void Awake()
        {
            ...
            _betaMove = GetComponent<BetaMove>();
            ToggleColliders(isStanding: true);
            _internalMaxSpeed = _stats.MaxSpeed;
        }
        ...
        protected virtual void HandleHorizontal()
        {
            ...
            else if (Crouching && _grounded)
            {
                ...
                var diminishedMaxSpeed = _internalMaxSpeed * Mathf.Lerp(1, _stats.CrouchSpeedPenalty, crouchPoint);
            ...
            else
            {
                ...
                _speed.x = Mathf.MoveTowards(_speed.x, xInput * _internalMaxSpeed, _currentWallJumpMoveMultiplier * _stats.Acceleration * Time.fixedDeltaTime);
            }
        }

        public void ChangeVelocity(float newVelocity)
        {
            _internalMaxSpeed = newVelocity;
        }
        #endregion
